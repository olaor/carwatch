#!/usr/bin/env python3
"""
tui.py – TUI browser for finnwatch.db
...
Usage:
    python3 tui.py
    python3 tui.py --db /path/to/finnwatch.db
...
DB_PATH = Path(__file__).parent / "database" / "finnwatch.db"
...
class FinnWatchTUI(App):
    ...
    def on_data_table_header_selected(self, event: DataTable.HeaderSelected) -> None:
        """Toggle sort on the clicked column and re-render the table."""
